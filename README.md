...
## Run website locally (three-click signup)
...
## Publish live (actual running app)

GitHub Pages cannot run this Python backend. Use Render for a live hosted service.

1. Push this branch to GitHub.
2. In Render, create a new **Blueprint** service and select this repo.
3. Render reads `render.yaml` automatically.
4. Set environment variable `EMAIL_RESPONDER_API_KEY` in Render dashboard.
5. Deploy and open your Render URL.

After deploy, verify:
- `https://<your-service>.onrender.com/healthz` returns `ok`
- Home page loads and the 3-click flow works.
...
This repository does not contain any real API key. You must create one from the provider you plan to use and put it in your local `.env` file or in your deployment platform environment settings.
